                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    if (typeof data["url"] === "undefined") {
                                        ...
                                        $("form[action='" + form_url + "']").append(
                                            `<button style="margin:0;display: block;float: none;clear: both;" id="customize" class="button button--primary" type="button">${data.personalize_button_label ?? 'customize'}</button>`
                                        );
                                    }
                                    ...
                                    <div class="product-item-info" data-container="product-grid">
                                                ...
                                                <span class="template-image-container">
                                                    <span class="template-image-wrapper">
                                                        <img src="${template.image}" alt="${template.title}" class="template-image-photo">
                                                    </span>
                                                </span>
                                            </a>
                                            <div class="template-item-details"><strong class="template-item-name"><a class="template-item-link">${template.title}</a></strong>
                                            <div class="price-box">
                                                <div class="template actions">
                                                    <div class="actions-primary">
                                                        <button type="submit" title="${template.title}" class="button primary">
